...
Y = ht_agg_pandas_df['mean_bmi'].to_frame()
...
# LabelEncoder.transform(series/column) this converts string types into integers which can be processed by databricks 
...
# TODO
X_1 = ht_agg_pandas_df[['mean_bmi', 'mean_active_heartrate']]
X_2 = ht_agg_pandas_df[['mean_resting_heartrate','mean_steps']]
X_3 = ht_agg_pandas_df[['mean_vo2', 'mean_steps']]
X_4 = ht_agg_pandas_df[['mean_bmi', 'mean_resting_heartrate']]
