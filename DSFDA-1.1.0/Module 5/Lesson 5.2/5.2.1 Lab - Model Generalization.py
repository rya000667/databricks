...
# TODO
train_2_rmse = np.sqrt(mean_squared_error(y_2_train, y_train_2_predicted))
train_2_mae = mean_absolute_error(y_2_train, y_train_2_predicted)
test_2_rmse = np.sqrt(mean_squared_error(y_2_test, y_test_2_predicted))
test_2_mae = mean_absolute_error(y_2_test, y_test_2_predicted)

train_3_rmse = np.sqrt(mean_squared_error(y_3_train, y_train_3_predicted))
train_3_mae = mean_absolute_error(y_3_train, y_train_3_predicted)
test_3_rmse = np.sqrt(mean_squared_error(y_3_test, y_test_3_predicted))
test_3_mae = mean_absolute_error(y_3_test, y_test_3_predicted)

train_4_rmse = np.sqrt(mean_squared_error(y_4_train, y_train_4_predicted))
train_4_mae = mean_absolute_error(y_4_train, y_train_4_predicted)
test_4_rmse = np.sqrt(mean_squared_error(y_4_test, y_test_4_predicted))
test_4_mae = mean_absolute_error(y_4_test, y_test_4_predicted)
